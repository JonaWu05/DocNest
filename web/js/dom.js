...
export const showIndexToggleEl = document.getElementById("show-index-toggle");
...
export const assetFolderTree = document.getElementById("asset-folder-tree");
export const assetCurrentDir = document.getElementById("asset-current-dir");
export const assetUploadBtn = document.getElementById("asset-upload-btn");
export const assetNewdirBtn = document.getElementById("asset-newdir-btn");
...
export const graphBtn = document.getElementById("graph-btn");
export const graphPane = document.getElementById("graph-pane");
export const graphCanvas = document.getElementById("graph-canvas");
export const graphEmpty = document.getElementById("graph-empty");
